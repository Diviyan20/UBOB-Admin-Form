...
def sync_media_library():
    ...
    if not BUCKET_NAME:
        raise ValueError(
            "VIDEO_BUCKET_NAME environment variable is not configured"
        )
    ...
    try:
        ...
        with get_db_connection() as (conn, cur):
            ...
            # -----------------------------------------------------
            # Commit the entire synchronization
            # -----------------------------------------------------
        ...
        raise ValueError(
            f"Error synchronizing media library: {e}"
        )
...
def get_all_media():
    ...
    try:
        ...
        raise ValueError(
            f"Error fetching media library: {e}"
        )